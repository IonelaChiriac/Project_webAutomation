...
public class CalendarEvent extends Base_class {
	...
	// initiallize all elements with WebDriver (PageFactory-> contains all the elements)
	...
	public void SetCalendarEvent(String textArea, String dates, String months, String years, String hours, String mins)
		...
		test.pass("After Inserting field values",
		MediaEntityBuilder.createScreenCaptureFromBase64String(capturescreenshotAsBase64("AfterInsertingallfieldsValues")).build());
